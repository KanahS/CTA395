...
def collect_particle_orbital_params(archive):
    ...
    for snap in range(len(sim_archive)): #range(10000): # for a non-high-timestep simulation, make this len(snap_num)
        sim = None 
...
Q1_high_time_step_f10_collection = ("/mnt/raid-cita/ksmith/cope_high-timestep_f10_longer/high_time-step_f10_longer_sim_archive_Q10.0_eb0.702_ap2.878.bin")
...
#np.save(dictionary_directory+"high_time_step_f10_10k_snaps_dict_Qinf_eb0.702_ap2.878.npy", Q1_high_time_step_f10_collection)
