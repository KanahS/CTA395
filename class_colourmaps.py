...
# IF YOU'D LIKE TO MAKE NEW ONES WITH YOUR NEWER CODE, UNCOMMENT THE LINE THAT SAVES THE MAP AT THE VERY ENDTO GET THESE, OR JUST USE MINE FOR NOW AND UNCOMMENT THEM:) 
